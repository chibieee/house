...
class SignIn extends React.Component {
    ...
    closeSignIn() {
        ...
        const activeSignInSlides = document.getElementsByClassName(
            "sign-up-item active"
        );
        activeSignInSlides[0].classList.remove("active");
                    ...
                    <form>
                        <div className="sign-up-item zero">
                            ...
                            <h3>
                                ...
                                adipiscing elit. Praesent rutrum arcu nisi, a
                                molestie nisi lobortis sed. Phasellus tortor
                                ipsum, efficitur et pharetra eget, aliquet id
                                nisi. Praesent vitae finibus quam, ut tempor ex.
                                Sed ut perspiciatis unde omnis iste natus error
                                sit voluptatem accusantium doloremque
                                laudantium, totam veritatis et quasi architecto
                        ...
                        <div className="sign-up-item four">
                            ...
                            <div className="sign-up-button-container">
                                ...
                                <button
                                    type="submit"
                                    className="sign-up-button confirm"
